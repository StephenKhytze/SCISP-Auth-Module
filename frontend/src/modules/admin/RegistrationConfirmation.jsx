      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        {loading ? (
          <div className="py-20 text-center space-y-3">
            <div className="w-8 h-8 border-3 border-[#80172B] border-t-transparent rounded-full animate-spin mx-auto" />
            <p className="text-xs font-bold text-slate-500">Loading student registration queue...</p>
          </div>
          ...
          <div className="py-20 text-center space-y-3">
            ...
            <p className="text-xs text-slate-500 max-w-sm mx-auto">
              There are currently no registration requests under the "{statusFilter || 'all'}" filter.
            </p>
          </div>
        ) : (
